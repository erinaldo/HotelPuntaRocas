...
{
    public partial class FrmEditarLiquidacion : Form
    {
        ...
        private static FrmEditarLiquidacion _mFormDefInstance;
        public static FrmEditarLiquidacion DefInstance
        {
            get
            {
                if (_mFormDefInstance == null || _mFormDefInstance.IsDisposed)
                    _mFormDefInstance = new FrmEditarLiquidacion();
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            oNegocio.UpdateLiquidacion(_idLiquidacion, "", txtSerie.Text, txtComprobante.Text, TipoPago(), double.Parse(lblSubTotal.Text), 
