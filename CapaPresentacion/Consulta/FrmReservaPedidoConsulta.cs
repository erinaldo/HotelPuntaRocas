...
{
    public partial class FrmReservaPedidoConsulta : Form
    {
        /*
         * Lista de Estados 
        ...
        */
        ...
        public FrmReservaPedidoConsulta(int idDetalle, int idReserva)
        {
            InitializeComponent();
        ...
        private void CargarProductosPedidos(int id)
        {
            ...
            vistaPedidoListBindingSource.DataSource = _servicioHabitacionN.SelectListView(item => item.id_grupo == id);
        }
        ...
        private void AgregarProducto()
        {
            if (dgvListaProductos.RowCount > 0)
            {
                ...
                _servicioHabitacionN.Insert(Asignar(true));
                    ...
                    _servicioHabitacionN.DescontarProducto(objEliminar.id_producto,
                        objEliminar.cantidad_servicio_habitacion);
        ...
        private void CalcularMontos()
        {
            ...
            var totalMonto = _servicioHabitacionN.SelectListView(item => item.id_grupo == id)
        ...
        private void pagarProductoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            _liquidacionN.Insert(Asignar(total));
            CalcularMontos();
        }
        ...
        private Liquidacion Asignar(decimal total)
        {
            ...
            if (huesped != null)
                _liquidacion = new Liquidacion()
                {
                    ...
                    real_liquidacion = total
                };
            return _liquidacion;
        }

        private void FrmReservaPedidoConsulta_KeyDown(object sender, KeyEventArgs e)
        {
