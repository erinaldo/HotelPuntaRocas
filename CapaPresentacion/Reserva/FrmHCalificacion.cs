...
{
    public partial class FrmHCalificacion : Form
    {
        ...
        public FrmHCalificacion(int idDetalleReserva,string codigo_reserva)
        {
            InitializeComponent();
        ...
        private void FrmHCalificacion_KeyDown(object sender, KeyEventArgs e)
        {
